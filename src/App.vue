<template>
	<v-app id="inspire">
		...
		>
			<v-list dense>
				<template v-for="item in articles">
					...
					<v-list-item v-else :key="item.text" :to="'/article/' + item.id">
						<v-list-item-action>
		...
		<template v-if="error">
			...
			>
				{{ error }}
				<v-btn color="dark" text @click.native="closeError"> Закрыть </v-btn>
			</v-snackbar>
		</template>
		...
		<template v-if="success">
			...
			>
				{{ success }}
				<v-btn color="dark" text @click.native="closeSuccess"> Закрыть </v-btn>
			</v-snackbar>
		</template>
	</v-app>
</template>
