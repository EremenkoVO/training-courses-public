        ...
        <v-dialog v-model="dialog" width="800px">
            ...
            <span v-if="isBranchMessages">
                ...
                <v-card id="message" class="mx-auto" v-for="b in messages" :key="b.id">
                    <v-card-title>
                        <v-avatar class="avatar" color="indigo" size="28"><v-icon dark>mdi-account-circle</v-icon></v-avatar>
                        {{nameUser(b.ownerId)}}
                    </v-card-title>
            ...
            <div class="title-forum-branch" v-else>
...
export default {
    ...
    computed: {
        ...
        isBranchMessages () {
            return this.allBranchMessages.length > 0;
        }
    },
    methods: {
        createMessage() {
